...
public class KLoadingView extends WrappedView {
    ...
    private int firstColor = Color.parseColor("#FF5252"),
            secColor = Color.parseColor("#E91E63"),
            trdColor = Color.parseColor("#C2185B");
    /**
     * 弧的宽高
     */
    private int arcWidth = -1, arcHeight = -1;
    private float ovalRadius = -1;
    private static final String DEFAULT_TEXT = "正在挑选";
